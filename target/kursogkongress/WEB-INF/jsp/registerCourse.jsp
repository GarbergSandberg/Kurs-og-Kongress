        ...
        <div class="form-group">
            <form name="courseForm">
                <div class="form-group">
                    ...
                    <input class="form-control" ng-model="course.title" id="title" name="title" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" ng-model="course.location" id="location" name="location" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="number" ng-model="course.courseFee" id="courseFee"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" ng-model="course.courseSingleDayFee" id="courseSingleDayFee"
