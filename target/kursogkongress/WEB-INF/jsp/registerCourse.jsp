...
<div ng-app="registerApp" id="sessionRegisterClass">
    <div ng-controller="AddCourseCtrl" style="margin-left:3em; margin-right:3em;">
        ...
        <div class="form-group">
            <form name="courseForm">
                <div class="form-group">
                    ...
                    <input autocomplete="off" class="form-control" ng-model="course.title" id="title" name="title" required>
                    <div ng-messages="courseForm.title.$error" ng-show="courseForm.title.$touched">
                        <div ng-message="required" style="color:red;">Vennligst fyll inn feltet.</div>
                    </div>
                </div>
                <div class="form-group">
                    <label for="description">Beskrivelse:</label>
                    <textarea ng-model="course.description" class="form-control" id="description" rows="3"
                              name="description" required></textarea>
                    <div ng-messages="courseForm.description.$error" ng-show="courseForm.description.$touched">
                        <div ng-message="required" style="color:red;">Vennligst fyll inn feltet.</div>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label"><i class="fa fa-calendar"></i><b> Start og
                        sluttdato</b></label><br>
                    <div class="form-group col-md-6" ng-class="{'has-error': datepickerForm.date.$invalid}">
                        <input type="text" class="form-control" ng-model="course.startDate" placeholder="Startdato"
                               name="date1" bs-datepicker required>
                        <div ng-messages="courseForm.date1.$error" ng-show="courseForm.date1.$touched">
                            <div ng-message="required" style="color:red;">Vennligst fyll inn feltet.</div>
                        </div>
                    </div>
                    <div class="form-group col-md-6" ng-class="{'has-error': datepickerForm.date.$invalid}">
                        <input type="text" class="form-control" ng-model="course.endDate" placeholder="Sluttdato"
                               name="date2" bs-datepicker required>
                        <div ng-messages="courseForm.date2.$error" ng-show="courseForm.date2.$touched">
                            <div ng-message="required" style="color:red;">Vennligst fyll inn feltet.</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input autocomplete="off" class="form-control" ng-model="course.maxNumber" id="maxnumber" type="number"
                           name="maxnumber" required>
                    <div ng-messages="courseForm.maxnumber.$error" ng-show="courseForm.maxnumber.$touched">
                        <div ng-message="required" style="color:red;">Vennligst fyll inn feltet.</div>
                        <div ng-message="number" style="color:red;">Feltet må være et tall.</div>
                    </div>
                </div>
                <div class="form-group">
                    <label for="location">Kurssted:</label>
                    <input autocomplete="off" class="form-control" ng-model="course.location" id="location" name="location" required>
                    <div ng-messages="courseForm.location.$error" ng-show="courseForm.location.$touched"
                ...
                <div class="input-group">
                    <input autocomplete="off" class="form-control" ng-model="role" id="role">
                        <span class="input-group-btn">
                            <button class="btn btn-primary" type="button" ng-click="addRole(role); role = '';">Legg
                                til
                            </button>
                        </span>
                </div>
                <table class="table">
                    <tr ng-repeat="role in roles">
                        ...
                        <td style="">
                            <button type="button" id="{{role}}" ng-click="removeRole(role)" class="close"
                                    aria-label="Close">
                ...
                <div ng-controller="AddSessionCtrl">
                    <table class="table session" ng-init="dateTable = dates">
                        <tr ng-repeat="date in dates" ng-init="sessionTableRow = $index">
                            ...
                            <td class="session"
                                ng-repeat="session in sessions | sessionFilter: sessionTableRow: dates | orderBy:'hourMinuteStart'">
                                <button id="sessionButton" data-ng-attr-id="btnId" type="button"
                                        ng-click="editSession(session)"
                                        ng-class="(session.overlap == true) ? 'btn btn-danger btn-block' : 'btn btn-default btn-block'"
                                        data-animation="am-fade-and-scale"
                                        data-template-url=${modalTemplate}
                                                bs-modal="modal">{{session.title}}<h5>({{session.startTime |
                ...
                <div ng-controller="AddEventCtrl">
                    ...
                    <div class="list-group">
                        <a class="list-group-item event" ng-repeat="event in events"
                           data-animation="am-fade-and-scale"
                ...
                <div class="form-group">
                    ...
                    <input autocomplete="off" class="form-control" type="number" ng-model="course.courseFee" id="courseFee"
                           name="courseFee" required>
                    <div ng-messages="courseForm.courseFee.$error" ng-show="courseForm.courseFee.$touched">
                        <div ng-message="required" style="color:red;">Vennligst fyll inn feltet.</div>
                        <div ng-message="number" style="color:red;">Feltet må være et tall.</div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <input autocomplete="off" class="form-control" ng-model="course.courseSingleDayFee" id="courseSingleDayFee"
                           type="number" name="courseSingleDayFee" required>
                    <div ng-messages="courseForm.courseSingleDayFee.$error"
                         ng-show="courseForm.courseSingleDayFee.$touched">
                        <div ng-message="required" style="color:red;">Vennligst fyll inn feltet.</div>
                        <div ng-message="number" style="color:red;">Feltet må være et tall.</div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <input autocomplete="off" class="form-control" ng-model="course.dayPackage" id="dayPackage" type="number"
                           name="dayPackage" required>
                    <div ng-messages="courseForm.dayPackage.$error" ng-show="courseForm.dayPackage.$touched">
                        <div ng-message="required" style="color:red;">Vennligst fyll inn feltet.</div>
                        <div ng-message="number" style="color:red;">Feltet må være et tall.</div>
                    </div>
                </div>
                ...
                <div ng-controller="addHotelCtrl">
                    ...
                    <div class="list-group">
                        <a class="list-group-item event" ng-repeat="hotel in hotels"
                           data-animation="am-fade-and-scale"
                ...
                <div ng-controller="RegistrationCtrl">
                    <div class="container">
                        <div class="jumbotron">
                                ...
                                <tr ng-repeat="opt in form.optionalPersonalia">
                                    ...
                                    <td style="">
                                        <button type="button" id="{{item}}"
                                                ng-click="removeInput(opt.parameter, 'personalia')"
                            ...
                            <button id="inputPersonalia" ng-click="buttonResolver('inputPersonalia')"
                                    class="{{classPersonalia[0]}}">Input
                            </button>
                            <button id="checkboxPersonalia" ng-click="buttonResolver('checkboxPersonalia')"
                                    class="{{classPersonalia[1]}}">Checkbox
                            </button>
                            <br>
                                <span class="{{hiddenPersonalia[0]}}">
                                    <div class="input-group">
                                        <input autocomplete="off" class="form-control" ng-model="inputPersonalia"
                                               placeholder="Skriv inn tekst som skal stå foran input">
                                        <span class="input-group-btn">
                                            <button class="btn btn-primary" type="button"
                                                    ng-click="addInput(inputPersonalia, 'Input', 'personalia'); inputPersonalia = '';">
                                                Legg til
                                            </button>
                                        </span>
                                    </div>
                                ...
                                <span class="{{hiddenPersonalia[1]}}">
                                    <div class="input-group">
                                        <input autocomplete="off" class="form-control" ng-model="inputPersonalia"
                                               placeholder="Skriv inn tekst som skal stå foran checkbox">
                                        <span class="input-group-btn">
                                            <button class="btn btn-primary" type="button"
                                                    ng-click="addInput(inputPersonalia, 'Checkbox', 'personalia'); inputPersonalia = '';">
                                                Legg til
                                            </button>
                                        </span>
                                    </div>
                            ...
                            <button id="inputWorkplace" ng-click="buttonResolver('inputWorkplace')"
                                    class="{{classWorkplace[0]}}">Input
                            </button>
                            <button id="checkboxWorkplace" ng-click="buttonResolver('checkboxWorkplace')"
                                    class="{{classWorkplace[1]}}">Checkbox
                            </button>
                            <br>
                                <span class="{{hiddenWorkplace[0]}}">
                                    <div class="input-group">
                                        <input autocomplete="off" class="form-control" ng-model="inputWorkplace"
                                               placeholder="Skriv inn tekst som skal stå foran input">
                                        <span class="input-group-btn">
                                            <button class="btn btn-primary" type="button"
                                                    ng-click="addInput(inputWorkplace, 'Input', 'workplace'); inputWorkplace = '';">
                                                Legg til
                                            </button>
                                        </span>
                                    </div>
                                ...
                                <span class="{{hiddenWorkplace[1]}}">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
                                            <button class="btn btn-primary" type="button"
                                                    ng-click="addInput(inputWorkplace, 'Checkbox', 'workplace'); inputWorkplace = '';">
                                                Legg til
                                            </button>
                                        </span>
                                    </div>
                            ...
                            <h4>Annet</h4>
                            <div class="checkbox">
                                <label><input type="checkbox" ng-model="form.airplane">Kurs og Kongress kan ordne
                                    bestillingsskjema for fly</label>
                            </div>
                            ...
                            <table class="table">
                                <tr ng-repeat="parameter in form.extraInfo">
                                    ...
                                    <td style="">
                                        <button type="button" id="{{parameter.parameter}}"
                                                ng-click="removeInput(parameter.parameter, 'extraInfo')"
                                                class="close" aria-label="Close">
                                            <span aria-hidden="true">&times;</span></button>
                                    </td>
                                </tr>
                            </table>
                            <button id="inputExtra" ng-click="buttonResolver('inputExtra')" class="{{class[0]}}">
                                Input
                            </button>
                            <button id="checkboxExtra" ng-click="buttonResolver('checkboxExtra')"
                                    class="{{class[1]}}">
                                Checkbox
                            </button>
                            <br>
                                <span class="{{hidden[0]}}">
                                    <div class="input-group">
                                        <input autocomplete="off" class="form-control" ng-model="inputQuestion"
                                               placeholder="Skriv inn tekst som skal stå foran input">
                                        <span class="input-group-btn">
                                            <button class="btn btn-primary" type="button"
                                                    ng-click="addInput(inputQuestion, 'Input', 'extraInfo'); inputQuestion = '';">
                                                Legg til
                                            </button>
                                        </span>
                                    </div>
                                ...
                                <span class="{{hidden[1]}}">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
                                            <button class="btn btn-primary" type="button"
                                                    ng-click="addInput(inputQuestion, 'Checkbox', 'extraInfo'); inputQuestion = '';">
                                                Legg til
                                            </button>
                                        </span>
                                    </div>
        ...
        <span style="float:right; margin-bottom: 15px;" ng-if="!courseForm.$valid">Påkrevd felt er ikke utfylt. &nbsp</span>
            ...
            <form name="courseForm">
                ...
                <div class="form-group">
                    <label class="control-label"><i class="fa fa-calendar"></i><b> Start og
                        sluttdato</b></label><br>
                    <div class="form-group col-md-6" ng-class="{'has-error': datepickerForm.date.$invalid}">
                        <input autocomplete="off" type="text" class="form-control" ng-model="course.startDate" placeholder="Startdato"
                               name="date1" bs-datepicker required>
                        <div ng-messages="courseForm.date1.$error" ng-show="courseForm.date1.$touched">
                            <div ng-message="required" style="color:red;">Vennligst fyll inn feltet.</div>
                        </div>
                    ...
                    <div class="form-group col-md-6" ng-class="{'has-error': datepickerForm.date.$invalid}">
                        <input autocomplete="off" type="text" class="form-control" ng-model="course.endDate" placeholder="Sluttdato"
                               name="date2" bs-datepicker required>
                        <div ng-messages="courseForm.date2.$error" ng-show="courseForm.date2.$touched">
                            <div ng-message="required" style="color:red;">Vennligst fyll inn feltet.</div>
                        </div>
                    ...
                    <div class="container">
                        <div class="jumbotron">
                            ...
                            <br>
                                ...
                                <span class="{{hiddenPersonalia[1]}}">
                                    <div class="input-group">
                                        <input class="form-control" ng-model="inputPersonalia"
                                               placeholder="Skriv inn tekst som skal stå foran checkbox">
                                        <span class="input-group-btn">
                                            <button class="btn btn-primary" type="button"
                                                    ng-click="addInput(inputPersonalia, 'Checkbox', 'personalia'); inputPersonalia = '';">
                            ...
                            <br>
                                ...
                                <span class="{{hiddenWorkplace[1]}}">
                                    <div class="input-group">
                                        <input class="form-control" ng-model="inputWorkplace"
                                               placeholder="Skriv inn tekst som skal stå foran checkbox">
                                        <span class="input-group-btn">
                                            <button class="btn btn-primary" type="button"
                                                    ng-click="addInput(inputWorkplace, 'Checkbox', 'workplace'); inputWorkplace = '';">
                            ...
                            <br>
                                ...
                                <span class="{{hidden[1]}}">
                                    <div class="input-group">
                                        <input class="form-control" ng-model="inputQuestion"
                                               placeholder="Skriv inn tekst som skal stå foran checkbox">
                                        <span class="input-group-btn">
                                            <button class="btn btn-primary" type="button"
                                                    ng-click="addInput(inputQuestion, 'Checkbox', 'extraInfo'); inputQuestion = '';">
