...
<div ng-app="RegApp">
    <div ng-controller="AddRegCtrl" class="page-header" style="margin-left:3em; margin-right:3em;">
        ...
        <div ng-repeat="opt in course.form.optionalWorkplace">
            ...
            <input type="checkbox" ng-hide="whichType(opt.type)" ng-model="registration.workplace.opt[$index]" id="opt"/>
            <input type="text" ng-show="whichType(opt.type)" ng-model="registration.workplace.opt[$index]" id="opt"/><br>
        </div>
        <hr/>
        ...
        <div style="display: inline-block; border-style: groove; max-width: 230px;"
            ...
            <form>
                ...
                <div ng-repeat="opt in course.form.optionalPersonalia">
                    <label for="opt">{{opt.parameter}}: </label>
                    <input type="checkbox" ng-hide="whichType(opt.type)" ng-model="registrations[n].person.opt[$index]" id="opt"/><br>
                    <input type="text" ng-show="whichType(opt.type)" ng-model="registrations[n].person.opt[$index]" id="opt"/><br><br>
                </div>
