                ...
                <div class="form-group">
                    <form name="userForm">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" ng-model="registration.person.firstname" name="firstname"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" type="number" ng-model="registration.person.phonenumber" ng-minlength="8"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" ng-model="registration.person.birthYear" id="birthyear"
                                       ng-minlength="4" ng-maxlength="4" id="number"type="number" name="birthyear" required/>
                        ...
                        <div class="form-group">
                            <label class="col-sm-4 control-label"></label>
                            <label>
                                <input type="radio" name="gender" value="Mann" ng-model="registration.person.gender" required>
                                Mann
                    ...
                    <div class="form-group" ng-repeat="opt in course.form.optionalPersonalia track by opt.id">
                        ...
                        <div class="col-sm-6" ng-show="whichType(opt.type)">
                            <input class="form-control" ng-model="registration.optionalPersonalia[$index]" name="$index"
                                   required/>
            ...
            <form name="workForm">
                <div class="form-horizontal" align="center" style="text-align: left; max-width: 90%; min-width: 60%;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="number" class="form-control" ng-model="registration.workplace.postalcode"
                                   ng-minlength="4" ng-maxlength="4" id="number"id="postalcode" name="postalcode" required/>
